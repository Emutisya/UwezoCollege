<section class="hero">
    <div class="hero__slider owl-carousel">
        <div class="hero__items set-bg" data-setbg="images/main1.png" style="max-height: 100vh">
        ...
        <div class="hero__items set-bg" data-setbg="images/main2.png" style="max-height: 100vh">
            <div class="hero__text" style="margin-top:30vh">
                <a href="{{ Route('about') }}" class="animated-btn">Apply Now</a>
                {{-- <a href="{{ Route('about') }}" class="primary-btn">Apply Now</a> --}}
                @include('partials.socials')
