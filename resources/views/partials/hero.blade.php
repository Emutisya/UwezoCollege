<section class="hero">
    <div class="hero__slider owl-carousel">
        <div class="hero__items set-bg" data-setbg="images/main1.png" style="max-height: 70vh">
        ...
        <div class="hero__items set-bg" data-setbg="images/blog4.jpeg" style="max-height: 70vh">
            <div class="hero__text" style="margin-top:30vh">
                <a href="https://elearning.uwezocollege.ac.ke/" target="_blank" class="animated-btn">Apply Now</a>
                {{-- <a href="https://elearning.uwezocollege.ac.ke/" target="_blank" class="primary-btn">Apply Now</a> --}}
                {{-- @include('partials.socials') --}}
        ...
        <div class="hero__items set-bg" data-setbg="images/uu9.jpg" style="max-height: 70vh">
            <div class="hero__text" style="margin-top:30vh">
                <a href="https://elearning.uwezocollege.ac.ke/" target="_blank" class="animated-btn">Apply Now</a>
                {{-- <a href="https://elearning.uwezocollege.ac.ke/" target="_blank" class="primary-btn">Apply Now</a> --}}
                {{-- @include('partials.socials') --}}
