@extends('layouts.app')
@section('content')
<div class="students row mt-5 mx-4">
    ...
    <div class="col-md-6 students-right wow fadeInRight animated" data-wow-delay=".5s">
        <div class="row">
            <div class="col-md-6 col-sm-12 my-2"> <img src="images/uu1.JPG" class="img-responsive zoom-img" alt="">
            </div>
            <div class="col-md-6 col-sm-12 my-2"> <img src="images/gd2.jpeg" class="img-responsive zoom-img" alt="">
            </div>
            <div class="col-md-6 col-sm-12 my-2"> <img src="images/uu4.JPG" class="img-responsive zoom-img" alt="">
            </div>
            <div class="col-md-6 col-sm-12 my-2"> <img src="images/uu3.JPG" class="img-responsive zoom-img" alt="">
            </div>
        </div>
